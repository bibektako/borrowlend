...
import 'package:borrowlend/features/home/data/data_source/category_data_source.dart';
  ...
  Future<List<CategoryEntity>> getCategory() async{
   try{
    ...
    if(response.statusCode == 200){
      GetAllCategoryDto getAllCategoryDto = GetAllCategoryDto.fromJson(response.data);
