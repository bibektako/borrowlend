...
NotificationDto({ required this.id, required this.sender, required this.type, required this.message, required this.isRead, this.link, required this.createdAt });
...
return NotificationUserDto(id: json['_id'], username: json['username']);
}
NotificationUserEntity toEntity() {
return NotificationUserEntity(id: id, username: username);
}
}
